if(CPACK_PACKAGE_FILE_NAME MATCHES ".*-src$")
    message(FATAL_ERROR "Creating source archives for SDL 3.4.8 is not supported.")
endif()

set(PROJECT_SOURCE_DIR "C:/dev/cpp/helloworld/build/vcpkg_installed/vcpkg/blds/sdl3/src/ease-3.4.8-4fc18f166d.clean")
...
set(CPACK_PACKAGE_FILE_NAME "SDL3-3.4.8-${SDL_CMAKE_PLATFORM}${SDL_CPU_NAMES_WITH_DASHES}")

if(CPACK_GENERATOR STREQUAL "DragNDrop")
    set(CPACK_DMG_VOLUME_NAME "SDL3 3.4.8")
